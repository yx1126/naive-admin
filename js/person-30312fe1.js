import{d as X,a as T,cu as wt,cv as Ct,B as l,cw as Re,r as Rt,U as Te,a1 as z,$ as f,a2 as B,a0 as $,ar as Bt,as as Ft,J as ke,ag as Et,a6 as te,L as Le,M as U,c as Y,a7 as We,I as De,cx as zt,z as ge,X as je,w as ve,aV as ee,O as St,F as me,ax as At,bb as $t,bW as Pt,b2 as Tt,aS as kt,cs as Be,P as se,a3 as Lt,q as le,a5 as de,cy as Wt,ah as Fe,V as Ee,cz as Dt,aN as Z,av as H,a9 as jt,E as It,br as Nt,R as Ot,_ as Mt,bo as Vt,b as ue,e as ce,f as i,g as s,i as M,h as Ht,j,c8 as Ut,am as O,ao as Xt,k as qt,b4 as Kt,an as Yt,l as ze,ap as Gt,aq as Jt,cA as Qt,cB as Zt}from"../assets/index.e8fe7c02.js";import{u as ea,_ as ta,B as aa}from"./index-0b5b50cf.js";import{A as na}from"./Add-20152ad7.js";import{t as Se}from"./toNumber-44751762.js";import{_ as ra}from"./Avatar-b776aa78.js";import{_ as oa}from"./GridItem-ea522890.js";import{a as ia,_ as sa}from"./RadioGroup-1c8ef552.js";import{_ as la}from"./Thing-23a97882.js";import{_ as da}from"./Grid-42927c50.js";const ua=Re(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[Re("&::-webkit-scrollbar",{width:0,height:0})]);var ca=X({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=T(null);function t(o){!(o.currentTarget.offsetWidth<o.currentTarget.scrollWidth)||o.deltaY===0||(o.currentTarget.scrollLeft+=o.deltaY+o.deltaX,o.preventDefault())}const r=wt();return ua.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Ct,ssr:r}),Object.assign({selfRef:e,handleWheel:t},{scrollTo(...o){var v;(v=e.value)===null||v===void 0||v.scrollTo(...o)}})},render(){return l("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}}),fa=function(){return Rt.Date.now()},fe=fa,ba="Expected a function",pa=Math.max,va=Math.min;function ma(e,t,r){var d,o,v,b,u,w,C=0,R=!1,_=!1,h=!0;if(typeof e!="function")throw new TypeError(ba);t=Se(t)||0,Te(r)&&(R=!!r.leading,_="maxWait"in r,v=_?pa(Se(r.maxWait)||0,t):v,h="trailing"in r?!!r.trailing:h);function g(y){var k=d,D=o;return d=o=void 0,C=y,b=e.apply(D,k),b}function m(y){return C=y,u=setTimeout(S,t),R?g(y):b}function F(y){var k=y-w,D=y-C,N=t-k;return _?va(N,v-D):N}function c(y){var k=y-w,D=y-C;return w===void 0||k>=t||k<0||_&&D>=v}function S(){var y=fe();if(c(y))return E(y);u=setTimeout(S,F(y))}function E(y){return u=void 0,h&&d?g(y):(d=o=void 0,b)}function A(){u!==void 0&&clearTimeout(u),C=0,d=w=o=u=void 0}function I(){return u===void 0?b:E(fe())}function W(){var y=fe(),k=c(y);if(d=arguments,o=this,w=y,k){if(u===void 0)return m(w);if(_)return clearTimeout(u),u=setTimeout(S,t),g(w)}return u===void 0&&(u=setTimeout(S,t)),b}return W.cancel=A,W.flush=I,W}var ha="Expected a function";function be(e,t,r){var d=!0,o=!0;if(typeof e!="function")throw new TypeError(ha);return Te(r)&&(d="leading"in r?!!r.leading:d,o="trailing"in r?!!r.trailing:o),ma(e,t,{leading:d,maxWait:t,trailing:o})}var ga=z([f("list",`
