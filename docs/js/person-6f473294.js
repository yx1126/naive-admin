import{d as U,a as W,cC as Ct,cD as Rt,G as s,cE as Fe,r as Et,U as Le,a1 as $,$ as b,a2 as F,a0 as A,aN as Ft,aO as Bt,J as We,ah as zt,a7 as ne,cF as St,L as De,M as V,c as Q,a9 as je,C as Ie,D as ge,X as Oe,w as ve,aR as ae,O as $t,F as me,ar as At,bh as Tt,c9 as Pt,b7 as kt,aM as Lt,cG as Wt,cB as Be,P as se,a4 as Dt,q as le,a6 as de,cH as jt,aT as M,ai as ze,V as Se,aI as te,ab as It,z as Ot,bw as Nt,R as Mt,bp as Ht,b as ce,e as ue,f as i,g as d,i as N,am as H,h as Vt,j as k,ao as Ut,_ as Xt,b9 as qt,an as Gt,k as $e,ap as Kt,aq as Yt,cI as Jt,cJ as Qt,m as Zt}from"../assets/index.efd02abb.js";import{A as ea,u as ta,F as aa,a as na,_ as ra}from"./index-49dcc37e.js";import{t as Ae}from"./toNumber-c0626cee.js";import{_ as oa,a as ia}from"./Grid-080df741.js";import{_ as sa}from"./Avatar-8e6a66bb.js";import{b as la,_ as da}from"./RadioGroup-dc775da2.js";import{_ as ca}from"./Thing-fa9e31d6.js";import"./index-d95ae7da.js";import"./index-10ca659f.js";import"./Forward-8afbdcac.js";const ua=Fe(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[Fe("&::-webkit-scrollbar",{width:0,height:0})]),fa=U({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=W(null);function t(c){!(c.currentTarget.offsetWidth<c.currentTarget.scrollWidth)||c.deltaY===0||(c.currentTarget.scrollLeft+=c.deltaY+c.deltaX,c.preventDefault())}const r=Ct();return ua.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Rt,ssr:r}),Object.assign({selfRef:e,handleWheel:t},{scrollTo(...c){var m;(m=e.value)===null||m===void 0||m.scrollTo(...c)}})},render(){return s("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var ba=function(){return Et.Date.now()};const fe=ba;var pa="Expected a function",va=Math.max,ma=Math.min;function ha(e,t,r){var o,c,m,g,l,_,x=0,C=!1,v=!1,u=!0;if(typeof e!="function")throw new TypeError(pa);t=Ae(t)||0,Le(r)&&(C=!!r.leading,v="maxWait"in r,m=v?va(Ae(r.maxWait)||0,t):m,u="trailing"in r?!!r.trailing:u);function y(w){var L=o,T=c;return o=c=void 0,x=w,g=e.apply(T,L),g}function R(w){return x=w,l=setTimeout(S,t),C?y(w):g}function z(w){var L=w-_,T=w-x,j=t-L;return v?ma(j,m-T):j}function p(w){var L=w-_,T=w-x;return _===void 0||L>=t||L<0||v&&T>=m}function S(){var w=fe();if(p(w))return E(w);l=setTimeout(S,z(w))}function E(w){return l=void 0,u&&o?y(w):(o=c=void 0,g)}function B(){l!==void 0&&clearTimeout(l),x=0,o=_=c=l=void 0}function D(){return l===void 0?g:E(fe())}function X(){var w=fe(),L=p(w);if(o=arguments,c=this,_=w,L){if(l===void 0)return R(_);if(v)return clearTimeout(l),l=setTimeout(S,t),y(_)}return l===void 0&&(l=setTimeout(S,t)),g}return X.cancel=B,X.flush=D,X}var ga="Expected a function";function be(e,t,r){var o=!0,c=!0;if(typeof e!="function")throw new TypeError(ga);return Le(r)&&(o="leading"in r?!!r.leading:o,c="trailing"in r?!!r.trailing:c),ha(e,t,{leading:o,maxWait:t,trailing:c})}const _a=$([b("list",`
