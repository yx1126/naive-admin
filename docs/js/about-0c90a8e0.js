import{L as m,J as e,aH as Y,M as R,K as V,ap as Z,aq as ee,d as B,G as oe,R as U,g as F,S as te,bP as re,T as ne,b9 as se,h as s,bQ as le,bR as ie,aK as M,f as N,o as ae,bp as de,j as k,k as O,l as f,m as d,F as G,n as H,q as K,s as ce,a7 as q,aa as J,x as A,p as Q,_ as pe}from"../assets/index-bb041c26.js";import{_ as be,a as he}from"./Grid-11b7a30a.js";function W(r,c="default",p=[]){const{children:n}=r;if(n!==null&&typeof n=="object"&&!Array.isArray(n)){const l=n[c];if(typeof l=="function")return l()}return p}const X="DESCRIPTION_ITEM_FLAG";function ge(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[X]:!1}const ue=m([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
 ...
 `))]),me=Object.assign(Object.assign({},U.props),{title:String,column:{type:Number,default:3},columns:Number,labelPlacement:{type:String,default:"top"},labelAlign:{type:String,default:"left"},separator:{type:String,default:":"},size:{type:String,default:"medium"},bordered:Boolean,labelStyle:[Object,String],contentStyle:[Object,String]}),fe=B({name:"Descriptions",props:me,setup(r){const{mergedClsPrefixRef:c,inlineThemeDisabled:p}=oe(r),n=U("Descriptions","-descriptions",ue,ie,r,c),l=F(()=>{const{size:i,bordered:b}=r,{common:{cubicBezierEaseInOut:g},self:{titleTextColor:y,thColor:o,thColorModal:h,thColorPopover:w,thTextColor:x,thFontWeight:T,tdTextColor:E,tdColor:j,tdColorModal:t,tdColorPopover:S,borderColor:I,borderColorModal:u,borderColorPopover:_,borderRadius:z,lineHeight:C,[M("fontSize",i)]:v,[M(b?"thPaddingBordered":"thPadding",i)]:P,[M(b?"tdPaddingBordered":"tdPadding",i)]:$}}=n.value;return{"--n-title-text-color":y,"--n-th-padding":P,"--n-td-padding":$,"--n-font-size":v,"--n-bezier":g,"--n-th-font-weight":T,"--n-line-height":C,"--n-th-text-color":x,"--n-td-text-color":E,"--n-th-color":o,"--n-th-color-modal":h,"--n-th-color-popover":w,"--n-td-color":j,"--n-td-color-modal":t,"--n-td-color-popover":S,"--n-border-radius":z,"--n-border-color":I,"--n-border-color-modal":u,"--n-border-color-popover":_}}),a=p?te("descriptions",F(()=>{let i="";const{size:b,bordered:g}=r;return g&&(i+="a"),i+=b[0],i}),l,r):void 0;return{mergedClsPrefix:c,cssVars:p?void 0:l,themeClass:a==null?void 0:a.themeClass,onRender:a==null?void 0:a.onRender,compitableColumn:re(r,["columns","column"]),inlineThemeDisabled:p}},render(){const r=this.$slots.default,c=r?ne(r()):[],p=c.length,{compitableColumn:n,labelPlacement:l,labelAlign:a,size:i,bordered:b,title:g,cssVars:y,mergedClsPrefix:o,separator:h,onRender:w}=this;w==null||w();const x=c.filter(t=>ge(t));p!==x.length&&se("descriptions","`n-descriptions` only takes `n-descriptions-item` as children.");const T={span:0,row:[],secondRow:[],rows:[]},j=x.reduce((t,S,I)=>{const u=S.props||{},_=x.length-1===I,z=["label"in u?u.label:W(S,"label")],C=[W(S)],v=u.span||1,P=t.span;t.span+=v;const $=u.labelStyle||u["label-style"]||this.labelStyle,D=u.contentStyle||u["content-style"]||this.contentStyle;if(l==="left")b?t.row.push(s("th",{class:`${o}-descriptions-table-header`,colspan:1,style:$},z),s("td",{class:`${o}-descriptions-table-content`,colspan:_?(n-P)*2+1:v*2-1,style:D},C)):t.row.push(s("td",{class:`${o}-descriptions-table-content`,colspan:_?(n-P)*2:v*2},s("span",{class:`${o}-descriptions-table-content__label`,style:$},[...z,h&&s("span",{class:`${o}-descriptions-separator`},h)]),s("span",{class:`${o}-descriptions-table-content__content`,style:D},C)));else{const L=_?(n-P)*2:v*2;t.row.push(s("th",{class:`${o}-descriptions-table-header`,colspan:L,style:$},z)),t.secondRow.push(s("td",{class:`${o}-descriptions-table-content`,colspan:L,style:D},C))}return(t.span>=n||_)&&(t.span=0,t.row.length&&(t.rows.push(t.row),t.row=[]),l!=="left"&&t.secondRow.length&&(t.rows.push(t.secondRow),t.secondRow=[])),t},T).rows.map(t=>s("tr",{class:`${o}-descriptions-table-row`},t));return s("div",{style:y,class:[`${o}-descriptions`,this.themeClass,`${o}-descriptions--${l}-label-placement`,`${o}-descriptions--${a}-label-align`,`${o}-descriptions--${i}-size`,b&&`${o}-descriptions--bordered`]},g||this.$slots.header?s("div",{class:`${o}-descriptions-header`},g||le(this,"header")):null,s("div",{class:`${o}-descriptions-table-wrapper`},s("table",{class:`${o}-descriptions-table`},s("tbody",null,j))))}}),_e={label:String,span:{type:Number,default:1},labelStyle:[Object,String],contentStyle:[Object,String]},ve=B({name:"DescriptionsItem",[X]:!0,props:_e,render(){return null}}),ye={class:"about"},we=B({name:"About"}),xe=B({...we,setup(r){let c=N({}),p=N({});return ae(async()=>{const n=Object.assign({"../../../package.json":()=>de(()=>import("./package-6db71ef8.js"),[])})["../../../package.json"],l=await n();c=l.dependencies,p=l.devDependencies}),(n,l)=>{const a=ve,i=fe,b=ce,g=be,y=he;return k(),O("div",ye,[f(y,{cols:1,"y-gap":"12"},{default:d(()=>[f(g,null,{default:d(()=>[f(b,{title:"生产环境依赖"},{default:d(()=>[f(i,{"label-placement":"left",column:3,bordered:""},{default:d(()=>[(k(!0),O(G,null,H(K(c),(o,h)=>(k(),q(a,{key:h},{label:d(()=>[J(A(h),1)]),default:d(()=>[Q("span",null,A(o),1)]),_:2},1024))),128))]),_:1})]),_:1})]),_:1}),f(g,null,{default:d(()=>[f(b,{title:"开发环境依赖"},{default:d(()=>[f(i,{"label-placement":"left",column:3,bordered:""},{default:d(()=>[(k(!0),O(G,null,H(K(p),(o,h)=>(k(),q(a,{key:h},{label:d(()=>[J(A(h),1)]),default:d(()=>[Q("span",null,A(o),1)]),_:2},1024))),128))]),_:1})]),_:1})]),_:1})]),_:1})])}}}),Ce=pe(xe,[["__file","/home/runner/work/naive-admin/naive-admin/src/views/other-pages/about.vue"]]);export{Ce as default};
