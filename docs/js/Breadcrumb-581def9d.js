import{$ as s,a1 as v,a2 as C,a0 as a,d as k,J as K,a7 as V,d2 as ae,L as W,M as Y,c as f,a9 as X,B as u,I as se,a as M,o as ie,x as ce,N as de,z as J,aP as A,aL as ue,ax as be,az as F,a4 as he,cV as me,cU as ve,aA as pe,aN as I,d3 as G,_ as Q,p as Z,cY as ge,b as S,e as q,f as fe,g as O,aj as j,c_ as ye,j as T,n as ee,m as xe,cO as _e,cD as Ce,h as Be,i as Se,l as D,F as ke,cj as we}from"../assets/index.038520d3.js";import{C as ze}from"./ChevronRight-98dbe7fd.js";import{l as Te,c as $e,p as Re}from"./Logo-94faf36d.js";import{_ as Le}from"./Dropdown-a4e0f1e8.js";var Pe=s("breadcrumb",`
 white-space: nowrap;
 cursor: default;
...
`,[v("ul",`
 ...
 `)]),a("separator",`
 display: none;
 `)])])]);const te=se("n-breadcrumb"),Ie=Object.assign(Object.assign({},V.props),{separator:{type:String,default:"/"}});var Me=k({name:"Breadcrumb",props:Ie,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:r}=K(e),n=V("Breadcrumb","-breadcrumb",Pe,ae,e,t);W(te,{separatorRef:Y(e,"separator"),mergedClsPrefixRef:t});const p=f(()=>{const{common:{cubicBezierEaseInOut:h},self:{separatorColor:m,itemTextColor:o,itemTextColorHover:b,itemTextColorPressed:y,itemTextColorActive:g,fontSize:B,fontWeightActive:x,itemBorderRadius:$,itemColorHover:R,itemColorPressed:L,itemLineHeight:H}}=n.value;return{"--n-font-size":B,"--n-bezier":h,"--n-item-text-color":o,"--n-item-text-color-hover":b,"--n-item-text-color-pressed":y,"--n-item-text-color-active":g,"--n-separator-color":m,"--n-item-color-hover":R,"--n-item-color-pressed":L,"--n-item-border-radius":$,"--n-font-weight-active":x,"--n-item-line-height":H}}),i=r?X("breadcrumb",void 0,p,e):void 0;return{mergedClsPrefix:t,cssVars:r?void 0:p,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;return(e=this.onRender)===null||e===void 0||e.call(this),u("nav",{class:[`${this.mergedClsPrefix}-breadcrumb`,this.themeClass],style:this.cssVars,"aria-label":"Breadcrumb"},u("ul",null,this.$slots))}});const Oe=de?window:null,je=(e=Oe)=>{const t=()=>{const{hash:p,host:i,hostname:h,href:m,origin:o,pathname:b,port:y,protocol:g,search:B}=(e==null?void 0:e.location)||{};return{hash:p,host:i,hostname:h,href:m,origin:o,pathname:b,port:y,protocol:g,search:B}},r=()=>{n.value=t()},n=M(t());return ie(()=>{e&&(e.addEventListener("popstate",r),e.addEventListener("hashchange",r))}),ce(()=>{e&&(e.removeEventListener("popstate",r),e.removeEventListener("hashchange",r))}),n},Ee={separator:String,href:String,clickable:{type:Boolean,default:!0},onClick:Function};var Ne=k({name:"BreadcrumbItem",props:Ee,setup(e,{slots:t}){const r=J(te,null);if(!r)return A("breadcrumb","`n-breadcrumb-item` must be placed inside `n-breadcrumb`."),()=>null;const{separatorRef:n,mergedClsPrefixRef:p}=r,i=je(),h=f(()=>e.href?"a":"span"),m=f(()=>i.value.href===e.href?"location":null);return()=>{const{value:o}=p;return u("li",{class:[`${o}-breadcrumb-item`,e.clickable&&`${o}-breadcrumb-item--clickable`]},u(h.value,{class:`${o}-breadcrumb-item__link`,"aria-current":m.value,href:e.href,onClick:e.onClick},t),u("span",{class:`${o}-breadcrumb-item__separator`,"aria-hidden":"true"},ue(t.separator,()=>{var b;return[(b=e.separator)!==null&&b!==void 0?b:n.value]})))}}}),Ve=s("layout-sider",`
 flex-shrink: 0;
