import{$ as s,a1 as p,a2 as C,a0 as a,d as k,J as K,a6 as V,cM as ne,L as W,M as A,c as f,a7 as q,B as u,I as ae,a as M,o as se,x as ie,N as ce,z as X,aI as de,aL as ue,aO as F,a3 as he,cC as be,cB as ve,aP as pe,aA as I,cN as G,_ as J,p as Q,cG as ge,b as S,e as Y,f as me,g as O,aj as E,cI as fe,j as T,n as Z,m as xe,ct as ye,ci as _e,h as Ce,i as Be,l as D,F as Se,c8 as ke}from"../assets/index.b366dfbb.js";import{C as ze,_ as we}from"./Dropdown-a78613fd.js";import{l as Te,c as $e,p as Re}from"./Logo-52eeaea8.js";var Pe=s("breadcrumb",`
 white-space: nowrap;
 cursor: default;
...
`,[p("ul",`
 ...
 `)]),a("separator",`
 display: none;
 `)])])]);const ee=ae("n-breadcrumb"),Le=Object.assign(Object.assign({},V.props),{separator:{type:String,default:"/"}});var Ie=k({name:"Breadcrumb",props:Le,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:r}=K(e),n=V("Breadcrumb","-breadcrumb",Pe,ne,e,t);W(ee,{separatorRef:A(e,"separator"),mergedClsPrefixRef:t});const g=f(()=>{const{common:{cubicBezierEaseInOut:b},self:{separatorColor:v,itemTextColor:o,itemTextColorHover:h,itemTextColorPressed:x,itemTextColorActive:m,fontSize:B,fontWeightActive:y,itemBorderRadius:$,itemColorHover:R,itemColorPressed:P,itemLineHeight:H}}=n.value;return{"--n-font-size":B,"--n-bezier":b,"--n-item-text-color":o,"--n-item-text-color-hover":h,"--n-item-text-color-pressed":x,"--n-item-text-color-active":m,"--n-separator-color":v,"--n-item-color-hover":R,"--n-item-color-pressed":P,"--n-item-border-radius":$,"--n-font-weight-active":y,"--n-item-line-height":H}}),i=r?q("breadcrumb",void 0,g,e):void 0;return{mergedClsPrefix:t,cssVars:r?void 0:g,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;return(e=this.onRender)===null||e===void 0||e.call(this),u("nav",{class:[`${this.mergedClsPrefix}-breadcrumb`,this.themeClass],style:this.cssVars,"aria-label":"Breadcrumb"},u("ul",null,this.$slots))}});const Me=ce?window:null,Oe=(e=Me)=>{const t=()=>{const{hash:g,host:i,hostname:b,href:v,origin:o,pathname:h,port:x,protocol:m,search:B}=(e==null?void 0:e.location)||{};return{hash:g,host:i,hostname:b,href:v,origin:o,pathname:h,port:x,protocol:m,search:B}},r=()=>{n.value=t()},n=M(t());return se(()=>{e&&(e.addEventListener("popstate",r),e.addEventListener("hashchange",r))}),ie(()=>{e&&(e.removeEventListener("popstate",r),e.removeEventListener("hashchange",r))}),n},Ee={separator:String,href:String,clickable:{type:Boolean,default:!0},onClick:Function};var je=k({name:"BreadcrumbItem",props:Ee,setup(e,{slots:t}){const r=X(ee,null);if(!r)return()=>null;const{separatorRef:n,mergedClsPrefixRef:g}=r,i=Oe(),b=f(()=>e.href?"a":"span"),v=f(()=>i.value.href===e.href?"location":null);return()=>{const{value:o}=g;return u("li",{class:[`${o}-breadcrumb-item`,e.clickable&&`${o}-breadcrumb-item--clickable`]},u(b.value,{class:`${o}-breadcrumb-item__link`,"aria-current":v.value,href:e.href,onClick:e.onClick},t),u("span",{class:`${o}-breadcrumb-item__separator`,"aria-hidden":"true"},de(t.separator,()=>{var h;return[(h=e.separator)!==null&&h!==void 0?h:n.value]})))}}}),Ne=s("layout-sider",`
 flex-shrink: 0;
