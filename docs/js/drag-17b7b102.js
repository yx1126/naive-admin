import{_ as Q}from"./CodeCard-9db5af07.js";import{J as M,K as d,M as j,bA as X,L as Y,d as D,w as Z,G as ee,R as O,a4 as te,g as V,S as oe,f as $,h as l,bB as ne,aI as re,aU as ae,aB as se,aw as le,aG as ie,bC as de,bD as ce,bE as ue,bF as fe,a5 as pe,bG as me,bH as ge,aK as f,by as ve,j as I,k as N,l as o,m as e,aa as c,W as P,a7 as he,q as h,am as R,p as H,bI as _e,bJ as be,y as we,ac as ye,ab as xe,s as Ce,bj as E,_ as ze}from"../assets/index-0ecb1455.js";import{_ as Me,a as $e}from"./Grid-010819a6.js";const ke=M("alert",`
...
`,[d("border",`
 ...
 border: var(--n-border);
 pointer-events: none;
 `),j("closable",[M("alert-body",[d("title",`
 padding-right: 24px;
 ...
 `,[Y("& +",[d("content",{marginTop:"9px"})])]),d("content",{transition:"color .3s var(--n-bezier)",fontSize:"var(--n-font-size)"})]),d("icon",{transition:"color .3s var(--n-bezier)"})]),Ae=Object.assign(Object.assign({},O.props),{title:String,showIcon:{type:Boolean,default:!0},type:{type:String,default:"default"},bordered:{type:Boolean,default:!0},closable:Boolean,onClose:Function,onAfterLeave:Function,onAfterHide:Function}),Be=D({name:"Alert",inheritAttrs:!1,props:Ae,setup(a){Z(()=>{a.onAfterHide!==void 0&&re("alert","`on-after-hide` is deprecated, please use `on-after-leave` instead.")});const{mergedClsPrefixRef:n,mergedBorderedRef:i,inlineThemeDisabled:p,mergedRtlRef:m}=ee(a),g=O("Alert","-alert",ke,me,a,n),L=te("Alert",m,n),k=V(()=>{const{common:{cubicBezierEaseInOut:t},self:r}=g.value,{fontSize:b,borderRadius:w,titleFontWeight:y,lineHeight:x,iconSize:C,iconMargin:B,iconMarginRtl:S,closeIconSize:z,closeBorderRadius:s,closeSize:U,closeMargin:W,closeMarginRtl:q,padding:G}=r,{type:u}=a,{left:K,right:J}=ge(B);return{"--n-bezier":t,"--n-color":r[f("color",u)],"--n-close-icon-size":z,"--n-close-border-radius":s,"--n-close-color-hover":r[f("closeColorHover",u)],"--n-close-color-pressed":r[f("closeColorPressed",u)],"--n-close-icon-color":r[f("closeIconColor",u)],"--n-close-icon-color-hover":r[f("closeIconColorHover",u)],"--n-close-icon-color-pressed":r[f("closeIconColorPressed",u)],"--n-icon-color":r[f("iconColor",u)],"--n-border":r[f("border",u)],"--n-title-text-color":r[f("titleTextColor",u)],"--n-content-text-color":r[f("contentTextColor",u)],"--n-line-height":x,"--n-border-radius":w,"--n-font-size":b,"--n-title-font-weight":y,"--n-icon-size":C,"--n-icon-margin":B,"--n-icon-margin-rtl":S,"--n-close-size":U,"--n-close-margin":W,"--n-close-margin-rtl":q,"--n-padding":G,"--n-icon-margin-left":K,"--n-icon-margin-right":J}}),v=p?oe("alert",V(()=>a.type[0]),k,a):void 0,A=$(!0),T=()=>{const{onAfterLeave:t,onAfterHide:r}=a;t&&t(),r&&r()};return{rtlEnabled:L,mergedClsPrefix:n,mergedBordered:i,visible:A,handleCloseClick:()=>{var t;Promise.resolve((t=a.onClose)===null||t===void 0?void 0:t.call(a)).then(r=>{r!==!1&&(A.value=!1)})},handleAfterLeave:()=>{T()},mergedTheme:g,cssVars:p?void 0:k,themeClass:v==null?void 0:v.themeClass,onRender:v==null?void 0:v.onRender}},render(){var a;return(a=this.onRender)===null||a===void 0||a.call(this),l(ne,{onAfterLeave:this.handleAfterLeave},{default:()=>{const{mergedClsPrefix:n,$slots:i}=this,p={class:[`${n}-alert`,this.themeClass,this.closable&&`${n}-alert--closable`,this.showIcon&&`${n}-alert--show-icon`,this.rtlEnabled&&`${n}-alert--rtl`],style:this.cssVars,role:"alert"};return this.visible?l("div",Object.assign({},ae(this.$attrs,p)),this.closable&&l(se,{clsPrefix:n,class:`${n}-alert__close`,onClick:this.handleCloseClick}),this.bordered&&l("div",{class:`${n}-alert__border`}),this.showIcon&&l("div",{class:`${n}-alert__icon`,"aria-hidden":"true"},le(i.icon,()=>[l(ie,{clsPrefix:n},{default:()=>{switch(this.type){case"success":return l(fe,null);case"info":return l(ue,null);case"warning":return l(ce,null);case"error":return l(de,null);default:return null}}})])),l("div",{class:[`${n}-alert-body`,this.mergedBordered&&`${n}-alert-body--bordered`]},pe(i.header,m=>{const g=m||this.title;return g?l("div",{class:`${n}-alert-body__title`},g):null}),i.default&&l("div",{class:`${n}-alert-body__content`},i))):null}})}}),Ie={class:"drag"},Re=H("h1",null,"v-drag",-1),Ee=H("p",null,'如果未使用 NModel 预设 根节点需设置 role="dialog"。',-1),Le=H("p",null,"例如：基础设置",-1),Te=D({name:"Drag"}),Se=D({...Te,setup(a){const n=$(!1),i=$(!1),p=$(!1),m=$(!1);let g;function L(){const _=_e(".n-modal.confirm"),t=_==null?void 0:_.querySelector(".n-dialog__title");g=be(t,{move:_})}function k(){g()}const v=`
<template>
