import{I as re,w as ne,aV as ae,aY as H,a as I,z as ie,M as U,a4 as G,K as j,J as O,aO as V,$ as _,a2 as g,a0 as s,a1 as R,aS as A,d as K,a7 as $,c as F,ah as M,a9 as N,B as y,ai as de,bn as L,av as D,L as se,P as le,Q as ce,aK as ue}from"../assets/index.67c47f0d.js";const be={name:String,value:{type:[String,Number,Boolean],default:"on"},checked:{type:Boolean,default:void 0},defaultChecked:Boolean,disabled:{type:Boolean,default:void 0},label:String,size:String,onUpdateChecked:[Function,Array],"onUpdate:checked":[Function,Array],checkedValue:{type:Boolean,default:void 0}},Y=re("n-radio-group");function he(e){ne(()=>{e.checkedValue!==void 0&&ae("radio","`checked-value` is deprecated, please use `checked` instead.")});const o=H(e,{mergedSize(n){const{size:l}=e;if(l!==void 0)return l;if(t){const{mergedSizeRef:{value:b}}=t;if(b!==void 0)return b}return n?n.mergedSize.value:"medium"},mergedDisabled(n){return!!(e.disabled||t!=null&&t.disabledRef.value||n!=null&&n.disabled.value)}}),{mergedSizeRef:r,mergedDisabledRef:d}=o,a=I(null),f=I(null),t=ie(Y,null),u=I(e.defaultChecked),i=U(e,"checked"),p=G(i,u),m=j(()=>t?t.valueRef.value===e.value:p.value),w=j(()=>{const{name:n}=e;if(n!==void 0)return n;if(t)return t.nameRef.value}),v=I(!1);function k(){if(t){const{doUpdateValue:n}=t,{value:l}=e;V(n,l)}else{const{onUpdateChecked:n,"onUpdate:checked":l}=e,{nTriggerFormInput:b,nTriggerFormChange:c}=o;n&&V(n,!0),l&&V(l,!0),b(),c(),u.value=!0}}function x(){d.value||m.value||k()}function C(){x()}function z(){v.value=!1}function S(){v.value=!0}return{mergedClsPrefix:t?t.mergedClsPrefixRef:O(e).mergedClsPrefixRef,inputRef:a,labelRef:f,mergedName:w,mergedDisabled:d,uncontrolledChecked:u,renderSafeChecked:m,focus:v,mergedSize:r,handleRadioInputChange:C,handleRadioInputBlur:z,handleRadioInputFocus:S}}var fe=_("radio",`
