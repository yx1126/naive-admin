import{C as G,$,ar as K,a1 as F,as as N,a0 as B,d as q,J as D,a as y,D as I,c as x,a7 as P,at as J,au as U,q as X,av as Y,a9 as Q,aw as Z,o as ee,w as re,B as te,ax as oe,G as R,ai as ne,V as ae}from"../assets/index.cf6f3e79.js";const C=!1,se=(e={})=>{var s;const{root:i=null}=e;return{hash:`${e.rootMargin||"0px 0px 0px 0px"}-${Array.isArray(e.threshold)?e.threshold.join(","):(s=e.threshold)!==null&&s!==void 0?s:"0"}`,options:Object.assign(Object.assign({},e),{root:(typeof i=="string"?document.querySelector(i):i)||document.documentElement})}},M=new WeakMap,_=new WeakMap,k=new WeakMap,ie=(e,s,i)=>{if(!e)return()=>{};const n=se(s),{root:l}=n.options;let a;const d=M.get(l);d?a=d:(a=new Map,M.set(l,a));let f,o;a.has(n.hash)?(o=a.get(n.hash),o[1].has(e)||(f=o[0],o[1].add(e),f.observe(e))):(f=new IntersectionObserver(h=>{h.forEach(c=>{if(c.isIntersecting){const g=_.get(c.target),S=k.get(c.target);g&&g(),S&&(S.value=!0)}})},n.options),f.observe(e),o=[f,new Set([e])],a.set(n.hash,o));let v=!1;const m=()=>{v||(_.delete(e),k.delete(e),v=!0,o[1].has(e)&&(o[0].unobserve(e),o[1].delete(e)),o[1].size<=0&&a.delete(n.hash),a.size||M.delete(l))};return _.set(e,m),k.set(e,i),m},le=G("n-avatar-group");var de=$("avatar",`
...
`,[K(F("&","--n-merged-color: var(--n-color-modal);")),N(F("&","--n-merged-color: var(--n-color-popover);")),F("img",`
 width: 100%;
 height: 100%;
 `),B("text",`
 white-space: nowrap;
