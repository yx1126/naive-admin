import{_ as G}from"./CodeCard-0d04f438.js";import{$ as E,a0 as i,a2 as S,cj as Q,a1 as X,d as j,w as Y,aV as Z,J as ee,a6 as V,ag as te,c as H,a7 as oe,a as y,B as l,O as ne,bW as re,aK as ae,ax as se,ck as le,cl as ie,cm as ue,cn as ce,ah as de,co as fe,cp as pe,cq as me,av as f,_ as _e,c1 as ge,b as $,e as T,f as o,g as e,a9 as L,aj as ve,j as M,i as N,am as u,cr as he,cs as be,m as Be,ao as we,an as Ce,k as Fe,c6 as k}from"../assets/index.0f1ee0ab.js";import{_ as Ee}from"./GridItem-93dd7f8f.js";import{_ as ye}from"./Grid-fb8b9957.js";var xe=E("alert",`
...
`,[i("border",`
 ...
 border: var(--n-border);
 pointer-events: none;
 `),S("closable",[E("alert-body",[i("title",`
 padding-right: 24px;
 `)])]),i("icon",{color:"var(--n-icon-color)"}),E("alert-body",{padding:"var(--n-padding)"},[i("title",{color:"var(--n-title-text-color)"}),i("content",{color:"var(--n-content-text-color)"})]),Q({originalTransition:"transform .3s var(--n-bezier)",enterToProps:{transform:"scale(1)"},leaveToProps:{transform:"scale(0.9)"}}),i("icon",`
 position: absolute;
 left: 0;
 top: 0;
 align-items: center;
 ...
 `),S("show-icon",[E("alert-body",{paddingLeft:"calc(var(--n-icon-margin-left) + var(--n-icon-size) + var(--n-icon-margin-right))"})]),E("alert-body",`
 border-radius: var(--n-border-radius);
 transition: border-color .3s var(--n-bezier);
 `,[i("title",`
