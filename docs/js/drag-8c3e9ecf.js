import{_ as G}from"./CodeCard-c72213e7.js";import{a3 as y,a4 as i,a6 as H,cu as J,a5 as Q,d as N,w as Y,N as Z,ab as j,al as ee,g as V,ad as te,f as E,h as l,cv as oe,S as ne,cd as re,aK as ae,av as se,cw as le,cx as ie,cy as ue,cz as ce,am as de,aV as fe,cA as pe,cB as me,aX as f,ck as ge,j as M,k as T,l as o,m as e,q as k,p as S,cb as ve,cC as he,aq as u,af as L,an as _e,cn as $,y as be,as as Be,ar as we,s as Ce,_ as Fe}from"../assets/index.dfdd9c17.js";import{_ as ye,a as Ee}from"./Grid-06d0c95e.js";const xe=y("alert",`
...
`,[i("border",`
 ...
 padding-right: 24px;
 `)])]),i("icon",{color:"var(--n-icon-color)"}),y("alert-body",{padding:"var(--n-padding)"},[i("title",{color:"var(--n-title-text-color)"}),i("content",{color:"var(--n-content-text-color)"})]),J({originalTransition:"transform .3s var(--n-bezier)",enterToProps:{transform:"scale(1)"},leaveToProps:{transform:"scale(0.9)"}}),i("icon",`
 position: absolute;
 left: 0;
 top: 0;
 align-items: center;
