import{I as re,w as ne,aN as ae,b5 as O,a as I,z as ie,M as U,a3 as G,K as H,J as j,aB as $,$ as _,a2 as g,a0 as s,a1 as R,aI as A,d as N,a6 as F,c as V,ag as M,a7 as K,B as y,ah as de,bi as L,av as D,L as se,P as le,Q as ce,az as ue}from"../assets/index.969219de.js";const be={name:String,value:{type:[String,Number,Boolean],default:"on"},checked:{type:Boolean,default:void 0},defaultChecked:Boolean,disabled:{type:Boolean,default:void 0},label:String,size:String,onUpdateChecked:[Function,Array],"onUpdate:checked":[Function,Array],checkedValue:{type:Boolean,default:void 0}},J=re("n-radio-group");function he(e){ne(()=>{e.checkedValue!==void 0&&ae("radio","`checked-value` is deprecated, please use `checked` instead.")});const o=O(e,{mergedSize(n){const{size:l}=e;if(l!==void 0)return l;if(t){const{mergedSizeRef:{value:b}}=t;if(b!==void 0)return b}return n?n.mergedSize.value:"medium"},mergedDisabled(n){return!!(e.disabled||t!=null&&t.disabledRef.value||n!=null&&n.disabled.value)}}),{mergedSizeRef:r,mergedDisabledRef:d}=o,a=I(null),f=I(null),t=ie(J,null),u=I(e.defaultChecked),i=U(e,"checked"),p=G(i,u),m=H(()=>t?t.valueRef.value===e.value:p.value),w=H(()=>{const{name:n}=e;if(n!==void 0)return n;if(t)return t.nameRef.value}),v=I(!1);function k(){if(t){const{doUpdateValue:n}=t,{value:l}=e;$(n,l)}else{const{onUpdateChecked:n,"onUpdate:checked":l}=e,{nTriggerFormInput:b,nTriggerFormChange:c}=o;n&&$(n,!0),l&&$(l,!0),b(),c(),u.value=!0}}function x(){d.value||m.value||k()}function C(){x()}function z(){v.value=!1}function S(){v.value=!0}return{mergedClsPrefix:t?t.mergedClsPrefixRef:j(e).mergedClsPrefixRef,inputRef:a,labelRef:f,mergedName:w,mergedDisabled:d,uncontrolledChecked:u,renderSafeChecked:m,focus:v,mergedSize:r,handleRadioInputChange:C,handleRadioInputBlur:z,handleRadioInputFocus:S}}var fe=_("radio",`
